...
- We introduce two key modules to extract and exploit pteryla-related information from bird images. The **Pteryla Relationship Mining ** module captures regional dependencies among appearance patterns across different body regions, while the **Key Cue Extraction ** module aggregates multi-scale semantic information and identifies informative regions under the guidance of learned pteryla-related cues.
